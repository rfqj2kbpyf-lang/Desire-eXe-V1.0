...
if (messageBody.startsWith(currentPrefix)) {
    ...
    if (chatSessions.isChatEnabled(chatId)) {
        ...
        const ownerJid = '2348129435079@s.whatsapp.net'; // YOUR_WHATSAPP_NUMBER@s.whatsapp.net(In This Format "234*********" without the "+").
...
function getSenderJid(msg) {
    ...
    if (msg.key.fromMe) {
        return '2348129435079@s.whatsapp.net'; // YOUR_WHATSAPP_NUMBER@s.whatsapp.net(In This Format "234*********" without the "+").
    }
